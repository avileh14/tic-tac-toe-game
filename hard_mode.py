...
def check_win(player):
    ...
    for col in range(BOARD_COLS):
        if board[0][col] == player and board[1][col] == player and board[2][col] == player and board[3][
            col] == player and board[4][col] == player:
    ...
    for row in range(BOARD_ROWS):
        if board[row][0] == player and board[row][1] == player and board[row][2] == player and board[row][
            3] == player and board[row][4] == player:
            ...
            return True
    # diagonal win check
    if board[0][0] == player and board[1][1] == player and board[2][2] == player and board[3][3] == player and board[4][
        4] == player:
        ...
        win_sound.play()
        return True
    if board[0][4] == player and board[1][3] == player and board[2][2] == player and board[3][1] == player and board[4][
        0] == player:
